...
get_aws_role_arn() {
    ...
    if command -v terraform &> /dev/null && [[ -f "../terraform/.terraform/terraform.tfstate" ]] || [[ -f "../terraform/terraform.tfstate" ]]; then
        cd ../terraform
...
update_reference_file() {
    ...
    cat > ../docs/github-secrets-reference.md << EOF
...
EOF
    ...
    echo -e "${GREEN}✅ Updated ../docs/github-secrets-reference.md${NC}"
}
...
display_summary() {
    ...
    echo "4. Local reference file updated: docs/github-secrets-reference.md"
}
